...
MASS::write.matrix(r, '/mnt/picea/projects/seidr/gold_standard/scere_pos.tsv')
...
MASS::write.matrix(neg_std, '/mnt/picea/projects/seidr/gold_standard/scere_neg.tsv')
...
MASS::write.matrix(r,
                   '/mnt/picea/projects/seidr/gold_standard/scere_pos_lo.tsv',
                   sep = '\t')
pmemy <- pmem[idx]
...
r <- t(do.call(cbind, r))
MASS::write.matrix(r,
                   '/mnt/picea/projects/seidr/gold_standard/scere_pos_lo_test.tsv',
                   sep = '\t')
