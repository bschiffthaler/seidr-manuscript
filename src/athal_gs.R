...
MASS::write.matrix(r, '/mnt/picea/projects/seidr/gold_standard/athal_pos.tsv')
...
MASS::write.matrix(neg_std, '/mnt/picea/projects/seidr/gold_standard/athal_neg.tsv')
